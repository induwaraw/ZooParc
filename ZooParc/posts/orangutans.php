...
<head>
    ...
    <style>
        body {
            ...
            padding: 0;
            color: #333;
            background-image: url('../images/oran.jpg'); 
...
<div class="container">
    <section class="about-section">
        <h2>Orangutans: Clever Climbers at ZooParc</h2><br>
        <div class="about-text">
<p>Our orangutans are part of the most intelligent and resourceful primate species in the animal kingdom and reside in our ZooParc. These great apes are kept in a spacious enclosure, furnished with plenty of trees, ropes, and platforms for climbing, swinging, and discovering. The orangutans are notoriously the loners of the primate kingdom, but on occasion, they can be inquisitive and watchful, observing their surroundings or any enrichment activities prepared for them by the zookeepers. These enrichments are designed to challenge them mentally and physically, since the orangutans are among the most intelligent animals, whose brains need exercise to be fit and healthy. One of the special features about our orangutans is that they use tools—something which visitors may well see them fashioning sticks to retrieve food or dealing with problems in a creative way that gives evidence of remarkable cognitive abilities.
</p>
